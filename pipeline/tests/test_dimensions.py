...
def _scan_frame():
    ...
    return pd.DataFrame(
        [
            {"nhl_game_id": 2021020001, "date": "2021-10-12", "season": 2021, "game_type": 2,
             "home_team": "FLA", "away_team": "TBL", "raw_venue": "FLA Live Arena"},
            {"nhl_game_id": 2022020002, "date": "2022-10-13", "season": 2022, "game_type": 2,
             "home_team": "FLA", "away_team": "BOS", "raw_venue": "Amerant Bank Arena"},
            {"nhl_game_id": 2022030003, "date": "2023-05-01", "season": 2022, "game_type": 3,
             "home_team": "TOR", "away_team": "MTL", "raw_venue": "Scotiabank Arena"},
        ],
        columns=["nhl_game_id", "date", "season", "game_type", "home_team", "away_team", "raw_venue"],
    )
